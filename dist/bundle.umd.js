;(function(global, factory) {
  ...
  var verify = function verify(a, b, name) {
    if (a !== b) {
      throw new Error(
        '\n*************************************************************\n* nanofp Error: Invalid argument for the function ' +
          (name || 'undefined') +
          '\n*************************************************************\n*  It looks like you may have passed an invalid argument\n*  This function was looking for a input of type ' +
          b +
          '\n*\n*  For more information visit:\n*\n*  https://github.com/twilson63/nanofp/blob/master/docs.md#' +
          (name || 'undefined') +
          '\n*\n*************************************************************\n'
      )
    }
  ...
  var concat = function concat() {
    for (
      var _len3 = arguments.length, arrs = Array(_len3), _key3 = 0;
      _key3 < _len3;
      _key3++
    ) {
  ...
  var merge = function merge() {
    for (
      var _len4 = arguments.length, objs = Array(_len4), _key4 = 0;
      _key4 < _len4;
      _key4++
    ) {
  ...
  function _curry(length, received, fn) {
    ...
    return function() {
      ...
      return left <= 0
        ? fn.apply(undefined, _toConsumableArray(combined))
